...
import { Settings, Bell, Globe, Key, Users, RefreshCw } from 'lucide-react';
...
export default function SettingsPage() {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="font-serif text-3xl text-forest-800 mb-1">Settings</h1>
        <p className="text-sm text-forest-500">Configure your content automation platform</p>
      </div>
      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="font-serif text-lg text-forest-800">RSS Agent Settings</h2>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              ...
              <select className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:border-forest-400">
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              ...
              <input type="number" defaultValue={40} min={0} max={100} className="w-20 border border-gray-200 rounded-lg px-3 py-2 text-sm text-center focus:outline-none focus:border-forest-400" />
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="font-serif text-lg text-forest-800">Content Generation</h2>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div>
                <div className="text-sm font-medium text-forest-800">Claude Model</div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="font-serif text-lg text-forest-800">Notifications</h2>
          </div>
          <div className="space-y-4">
            {[
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="font-serif text-lg text-forest-800">Social Platform Connections</h2>
          </div>
          <div className="space-y-3">
            {[
              ...
              <div key={item.platform} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div>
                  <div className="text-sm font-medium text-forest-800">{item.platform}</div>
                  <div className="text-xs text-gray-500">{item.desc}</div>
                </div>
                <button className={`px-4 py-2 rounded-lg text-xs font-medium transition-colors ${
                  item.connected
                    ? 'bg-green-50 text-green-700 border border-green-200'
                    : 'bg-forest-600 text-cream-100 hover:bg-forest-700'
                }`}>
